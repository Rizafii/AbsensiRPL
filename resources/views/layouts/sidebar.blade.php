...
>
    ...
    <div class="relative flex h-48 items-center justify-center px-2 border-b border-slate-100">
        <a href="{{ route('dashboard') }}" class="flex items-center justify-center overflow-hidden w-full">
            <img src="{{ asset('assets/Logo.png') }}" alt="Logo" class="h-40 w-full object-contain transition-all duration-300">
        </a>
    </div>
    ...
    <nav class="flex-1 space-y-1.5 p-3 overflow-y-auto">
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 shrink-0 transition-colors">
        ...
        <a href="{{ route('settings.attendance.edit') }}"
           class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200
                  {{ request()->routeIs('settings.*') ? 'bg-[#2D5A43] text-white shadow-md shadow-emerald-900/10' : 'text-slate-600 hover:bg-emerald-50 hover:text-[#2D5A43]' }}"
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 shrink-0 transition-colors">
    ...
    <div class="border-t border-slate-100 p-3">
        <div class="flex items-center gap-3 rounded-xl px-3 py-2.5 bg-slate-50 border border-slate-100">
            <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-xs font-bold text-slate-600 shadow-sm uppercase">
